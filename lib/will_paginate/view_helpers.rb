...
module WillPaginate
  ...
  class LinkRenderer
    ...
    def to_html
      ...
      links.unshift page_link_or_span(@collection.previous_page, 'disabled prev_page', @options[:previous_label]) unless @options[:previous_label].blank?
      links.push    page_link_or_span(@collection.next_page,     'disabled next_page', @options[:next_label]) unless @options[:next_label].blank?
